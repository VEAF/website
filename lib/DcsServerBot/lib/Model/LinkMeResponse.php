...
/**
 * LinkMeResponse Class Doc Comment
 *
 * @category Class
 * @package  DcsServerBot
 * @author   OpenAPI Generator team
 ...
 */
class LinkMeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkMeResponse';
    ...
    */
     ...
     * Sets rc
     *
     * @param int $rc Return code bitmask (1=User linked, 2=Link in progress, 4=Force operation)
     *
     * @return self
     */
