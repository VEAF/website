 ...
 */
class TopMission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TopMission';
    ...
    {
        $this->setIfExists('mission_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mission_name'] === null) {
            $invalidProperties[] = "'mission_name' can't be null";
        }
    ...
    {
        return $this->container['mission_name'];
    }

    /**
     * Sets mission_name
     *
     * @param string $mission_name mission_name
     *
     * @return self
     */
    public function setMissionName($mission_name)
    {
        if (is_null($mission_name)) {
            throw new \InvalidArgumentException('non-nullable mission_name cannot be null');
        }
        $this->container['mission_name'] = $mission_name;
