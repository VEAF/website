...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'loc' => '\DcsServerBot\Model\ValidationErrorLocInner[]',
        'msg' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets loc
     *
     * @return \DcsServerBot\Model\ValidationErrorLocInner[]
     */
     ...
     * Sets loc
     *
     * @param \DcsServerBot\Model\ValidationErrorLocInner[] $loc loc
     *
     * @return self
     */
