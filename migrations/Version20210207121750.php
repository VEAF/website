...
final class Version20210207121750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pe_DataRaw (pe_dataraw_type INT NOT NULL, pe_DataMissionHashes_instance INT NOT NULL, pe_dataraw_payload MEDIUMTEXT DEFAULT NULL, pe_dataraw_updated datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY(pe_dataraw_type, pe_DataMissionHashes_instance)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pe_OnlinePlayers (id INT AUTO_INCREMENT NOT NULL, pe_OnlinePlayers_ping INT DEFAULT NULL, pe_OnlinePlayers_side INT DEFAULT NULL, pe_OnlinePlayers_ucid VARCHAR(255) DEFAULT NULL, pe_OnlinePlayers_slot VARCHAR(255) DEFAULT NULL, pe_OnlinePlayers_updated datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, pe_OnlinePlayers_id BIGINT NOT NULL, pe_OnlinePlayers_instance INT NOT NULL, INDEX IDX_676CFD2FB0467609 (pe_OnlinePlayers_id), INDEX IDX_676CFD2FC31A124 (pe_OnlinePlayers_instance), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pe_OnlineStatus (pe_OnlineStatus_instance INT NOT NULL, pe_OnlineStatus_theatre VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_name VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_players INT DEFAULT NULL, pe_OnlineStatus_pause VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_multiplayer VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_realtime VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_modeltime VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_perunversion_winapp VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_perunversion_dcshook VARCHAR(255) DEFAULT NULL, pe_OnlineStatus_updated datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY(pe_OnlineStatus_instance)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pe_LogEvent CHANGE pe_LogEvent_datetime pe_LogEvent_datetime DATETIME DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('ALTER TABLE pe_DataRaw DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE pe_DataRaw CHANGE pe_datamissionhashes_instance pe_dataraw_instance INT NOT NULL');
        $this->addSql('ALTER TABLE pe_DataRaw ADD PRIMARY KEY (pe_dataraw_type, pe_dataraw_instance)');
        $this->addSql('ALTER TABLE pe_LogChat ADD pe_LogChat_playerid VARCHAR(100) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        // never down this first migration ...
    }
}
