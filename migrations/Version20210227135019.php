 ...
 */
final class Version20210227135019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, map_id INT DEFAULT NULL, image_id INT DEFAULT NULL, owner_id INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, type INT NOT NULL, sim_dcs TINYINT(1) NOT NULL, sim_bms TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, restrictions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', deleted TINYINT(1) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_3BAE0AA753C55F64 (map_id), INDEX IDX_3BAE0AA73DA5256D (image_id), INDEX IDX_3BAE0AA77E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
